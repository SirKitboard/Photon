...
namespace cse380 {
  namespace bugginout {
    ...
    static const wstring    W_DATA_DIR = L"data/";
    ...
    static const wstring    W_INIT_FILE = L"BugginOutInit.txt";
    static const wstring    W_GUI_INIT_FILE = L"BugginOutGUI.txt";
	...
	static const wstring	W_SPLASH_SCREEN_PATH = L"data/gui/overlays/photon_splash2.png";
	static const wstring	W_MAIN_MENU_PATH = L"data/gui/overlays/photon_menu.png";
	static const wstring	W_RDM_PATH = L"data/gui/overlays/rdm.png";
	static const wstring	W_START_IMAGE_PATH = L"data/gui/buttons/play.png";
	static const wstring	W_START_IMAGE_MO_PATH = L"data/gui/buttons/play_h.png";
	static const wstring	W_QUIT_IMAGE_PATH = L"data/gui/buttons/exit.png";
	static const wstring	W_QUIT_IMAGE_MO_PATH = L"data/gui/buttons/exit_h.png";
	...
	static const wstring	W_ABOUT_IMAGE_H_PATH = L"data/gui/buttons/about_h.png";
	static const wstring	W_HELP_IMAGE_PATH = L"data/gui/buttons/help.png";
	static const wstring	W_HELP_IMAGE_H_PATH = L"data/gui/buttons/help_h.png";
