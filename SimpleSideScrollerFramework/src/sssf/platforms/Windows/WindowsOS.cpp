...
namespace cse380 {
  namespace sssf {
    namespace win32 {
      ...
      LRESULT static CALLBACK WinProc(
        HWND hWnd,
        UINT message,
        WPARAM wParam,
        LPARAM lParam
      ...
      WindowsOS::WindowsOS(
        ...
        // WINDOWS CAN EITHER BE IN WINDOWED MODE, MEANING THE WINDOW PLAYS NICELY
        // WITH OTHER APPLICATIONS AND CAN BE RESIZED, MINIMIZED, MAXIMIZED, ETC.,
        // OR IT CAN BE IN FULLSCREEN MODE, IN WHICH CASE IT LIKES TO HOG RESOURCES
        // AND CANNOT BE RESIZED. GAMES IN FULL SCREEN MODE GET MORE OF THE SYSTEM
        // RESOURCES, BUT CAN ONLY SWITCH TO ANOTHER APPLICATION VIA EITHER ALT-TAB,
        // OR BY CLOSING THE APPLICATION VIA SOME GAME CONTROL (i.e. BUTTON).
        long initStyle = isFullscreen ? fullscreenStyle : windowedStyle;

        // WE'LL EGIZE THIS STRUCTURE TO CREATE OUR OWN WINDOW CLASS
        WNDCLASSEX wc;

        // EMPTY THE wc STRUCTURE
        ZeroMemory(&wc, sizeof(WNDCLASSEX));

        // FILL IN THE wc VARIABLES TO CREATE OUR OWN WINDOW TYPE
        ...
        // NAME DOESN'T MATTER AS LONG AS WE USE THE SAME NAME 
        // WHEN WE CALL CreateWindowEx
      ...
      void WindowsOS::processOSMessages() {
        ...
        // CHECK TO SEE IF ANY WINDOWS MESSAGES ARE WAITING IN THE QUEUE. FOR
        // EXAMPLE, DID SOMEONE HIT THE WINDOW'S X TO CLOSE THE APPLICATION?
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE)) {
          // TRANSLATE THE MESSAGE AND SEND IT ON TO OUR ASSIGNED MESSAGE
          // HANDLER, WHICH WE NAMED WinProc WHEN WE CREATED THE WINDOW
      ...
      LRESULT static CALLBACK WinProc(
        ...
        case WM_DESTROY:
          ...
          // SOMEONE EITHER MOVED THE WINDOW, MAXIMIZED IT, OR THE CURSOR JUST
          // ENTERED THE WINDOW FROM PREVIOUSLY BEING OUTSIDE. THESE THINGS ARE
          // ONLY A CONCERN IN WINDOWED MODE. BTW, WINDOWS DOESN'T SEEM TO FIRE
          // THE WM_NCMOUSELEAVE EVENT WHEN ENTERING THE NON-CLIENT AREA FROM
          // BELOW THE WINDOW IN THE SOUTH, WHICH MEANS THE WINDOWS CURSOR MIGHT
          // POP UP IN THAT CASE. THE SOLUTION? USE FULLSCREEN MODE IN THE RELEASE
        ...
        // LET WINDOWS TAKE CARE OF ANY MESSAGES WE DON'T CARE ABOUT
